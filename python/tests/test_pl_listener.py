...
def test_rebuild_listener():
    ...
    def add_stock(client: FakeClient, account: str, stock_ticker: str):
        client.sadd("stocks", f"{account}:{stock_ticker}")
    ...
    add_stock(client, account, ticker)
    ...
    print(pl_today)
    assert round(pl_today.trade_pl, 2) == 13.50  #13.5
    assert round(pl_today.position_pl, 2) == 8.00 #8.00
