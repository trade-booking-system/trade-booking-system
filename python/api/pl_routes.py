...
async def get_trade_profit_loss(id: str, client: redis.Redis = Depends(get_redis_client)) -> TradeProfitLoss:
...
async def get_all_profit_loss(account: str, client: redis.Redis = Depends(get_redis_client)) -> list[ProfitLoss]:
    return None
