...
def update_trade(trade_id: str, account: str, date: str, updated_type: str= None, updated_amount: int= None, 
                 client: redis.Redis = Depends(get_redis_client_zero)) -> Dict[str, str]:
...
def get_trade_history(trade_id: str, account: str, date: str, client: redis.Redis = Depends(get_redis_client_zero)) -> History:
